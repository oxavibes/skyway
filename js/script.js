...
(function ($) {
    ...
    if ($('#map-location')
        ...
        map = new GMaps({
            el: '#map-location',
            zoom: 14,
            scrollwheel: false, //Set Latitude and Longitude Here
            lat: -37.817085,
            lng: 144.955631
        });
    ...
    //Hide cargo locations
    $('.cargo-shipping').fadeOut();
    ...
    //Show/Hide Cargo options based on the user selection
    function toggleCargoLocations(){
        $('#calculate-1-select').on('change', function() {
    ...
    function cargoShippingCost(height, width, length) {
        ...
        cargo_cost_three = (cargo_cost_three < min_cost_three) ? min_cost_three : cargo_cost_three;  
            ...
            switch(selected_location) {
                case '1':
                    return cargo_cost_one;
                case '2':
                    return cargo_cost_two;
                case '3':
                    return cargo_cost_three;
            }
    }
    ...
    //Ship Calculator
    $('#shipping-calculator-form').on('submit', function (event) {
        event.preventDefault();

        var total = 0;
        var length = $('#calculate-1-length').val() || null;
        var height = $('#calculate-1-height').val() || null;
        var width = $('#calculate-1-width').val() || null;
